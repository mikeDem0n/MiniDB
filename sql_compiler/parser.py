...
from .ast_nodes import (
    SQLProgram, Statement, Expression, CreateTableStatement, InsertStatement,
    SelectStatement, DeleteStatement, ColumnDef, DataType,
...
class SQLParser:
    ...
    def parse_statement(self) -> Optional[Statement]:
        ...
        if self.match(TokenType.KEYWORD):
            ...
            raise ParseError("Expected statement", self.current_token, "CREATE, INSERT, SELECT, or DELETE")
