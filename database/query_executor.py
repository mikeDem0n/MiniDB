...
from sql_compiler import SQLLexer, SQLParser, SemanticAnalyzer, PlanGenerator
    ...
    def _execute_select(self, plan: Dict[str, Any]) -> QueryResult:
        ...
        try:
            ...
            if operation == 'PROJECT':
                ...
                # 应用过滤条件
                if condition:
                    child_result.data = self._apply_where_condition(child_result.data, condition)
                ...
                return QueryResult(True, f"扫描完成，获取 {len(result_records)} 条记录", 
                                 data=result_records)
